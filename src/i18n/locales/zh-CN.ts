...
export default {
  ...
  "localMusic": {
    ...
    "entityEditorHint": "编辑展示身份、合并重复{{kind}}，或将选中的歌曲拆分到新{{kind}}。",
    ...
    "entitySplitHint": "先输入新{{kind}}名称，再选择需要移动到新{{kind}}的歌曲。",
    ...
    "folderSongInfoHint": "为此文件夹内 {{count}} 首歌曲匹配元数据与封面；不会自动把文件夹名称当作元数据。",
    "batchMetadataMatch": "批量自动匹配",
    "batchMetadataMatchHint": "优先通过网易云匹配元数据与封面，必要时回退 QQ；不会请求歌词。",
    "cancelMatch": "取消",
