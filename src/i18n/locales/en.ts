...
export default {
  ...
  "localMusic": {
    ...
    "entityEditorHint": "Edit the displayed identity, merge duplicates, or move selected songs into a new group for {{kind}}.",
    ...
    "entitySplitHint": "Enter a new name for {{kind}}, then choose the songs that should move to it.",
    ...
    "folderSongInfoHint": "Match metadata and covers for {{count}} songs in this folder. Folder names are never used as metadata automatically.",
    "batchMetadataMatch": "Batch automatic match",
    "batchMetadataMatchHint": "Match metadata and covers through NetEase first, then QQ when needed. Lyrics are not requested.",
    "cancelMatch": "Cancel",
