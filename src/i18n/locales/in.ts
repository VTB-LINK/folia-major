export default {
  ...
  "options": {
    ...
    "importConfirmDesc": "Konfigurasi yang diimpor akan menggantikan pengaturan di bawah. Grup yang tidak dicentang tetap seperti sekarang.",
    ...
    "importValueAdjusted": "Disesuaikan",
